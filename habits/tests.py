...
class HabitsTestCase(APITestCase):
    def setUp(self):
        self.user = User.objects.create(email="larisa.mih@mail.ru", password="123qwer")
    ...
    def test_detail_habit(self):
        ...
        response = self.client.get(f"/habits/view/{self.habit.id}", data=data)
        print("RESPONSE", response.content)
    ...
    def test_update_habit(self):
        ...
        response = self.client.patch(f"/habits/edit/{self.habit.id}", data=data)
        print("RESPONSE", response.json())
    ...
    def test_delete_habit(self):
        ...
        response = self.client.delete(f"/habits/delete/{self.habit.id}", data=data)
        print("RESPONSE", response.content)
